...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const navigationItems: NavigationItem[] = [
    ...
    { name: 'Courses', href: '/institution/courses', icon: FileText },
    { name: 'Events', href: '/institution/events', icon: MessageSquare },
    { name: 'Reports', href: '/institution/reports', icon: BarChart2 },
    { name: 'Settings', href: '/institution/settings', icon: Settings },
  ]

  const isActive = (href: string) => {
    if (href === '/institution') {
      return pathname === '/institution'
    }
